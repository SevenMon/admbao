...
class Wechat {
	...
	const APPID                   ='wxc21d36b6515b1fdd';
	const SECRET                  ='540d952545601601bb9bb39f3aa0dad4';
	const TOKEN                   ='laundry';
	...
	public function __construct($options = array()) {
		$this->token        =  isset($options['token'])        ? $options['token']        : self::TOKEN;
		$this->appid        =  isset($options['appid'])        ? $options['appid']        : self::APPID;
		$this->secret       =  isset($options['secret'])       ? $options['secret']       : self::SECRET;
